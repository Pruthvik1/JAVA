...
class TicTacToe {
	public static void main(String[] args) {
		...
		// Create a variable to represent the size of our tic tac toe board
		int n = 4;
	...
	//   a function to draw the tic tac toe board
	...
	//  a function to see if someone has won and return the winning char
	...
	//  a function to check if all of the positions on the board have been filled
